<?php namespace App\Http\Controllers;
	...
	class AdminPaymentStatusesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "payment_status";
			$this->limit = "20";
			$this->orderby = "payment_status,asc";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Payment Status','name'=>'payment_status','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-6'];
