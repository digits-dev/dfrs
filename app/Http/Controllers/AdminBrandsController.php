<?php namespace App\Http\Controllers;
	...
	class AdminBrandsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Brand Code','name'=>'brand_code','type'=>'text','validation'=>'required|min:1|max:20','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Brand Name','name'=>'brand_name','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-6'];
