<?php namespace App\Http\Controllers;
	...
	class AdminChartAccountTypesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "chart_account_type";
			$this->limit = "20";
			$this->orderby = "chart_account_type,asc";
			...
			$this->table = "chart_account_types";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Chart Account Type","name"=>"chart_account_type"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Chart Account Type','name'=>'chart_account_type','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-6'];
