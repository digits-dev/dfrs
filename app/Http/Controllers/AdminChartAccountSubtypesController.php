<?php namespace App\Http\Controllers;
	...
	class AdminChartAccountSubtypesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "chart_account_subtype";
			$this->limit = "20";
			$this->orderby = "chart_account_subtype,asc";
			...
			$this->table = "chart_account_subtypes";
