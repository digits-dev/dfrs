...
use Illuminate\Http\Request;
	...
	class AdminLocationsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Location Code","name"=>"location_code"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Location Code','name'=>'location_code','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Location Name','name'=>'location_name','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-6'];
