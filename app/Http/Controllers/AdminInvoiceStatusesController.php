<?php namespace App\Http\Controllers;
	...
	class AdminInvoiceStatusesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "invoice_status";
			$this->limit = "20";
			$this->orderby = "invoice_status,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Invoice Status","name"=>"invoice_status"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Invoice Status','name'=>'invoice_status','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-6'];
