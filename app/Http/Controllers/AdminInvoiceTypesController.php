<?php namespace App\Http\Controllers;
	...
	class AdminInvoiceTypesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "invoice_type";
			$this->limit = "20";
			$this->orderby = "invoice_type,asc";
			...
			$this->table = "invoice_types";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Invoice Type","name"=>"invoice_type"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Invoice Type','name'=>'invoice_type','type'=>'text','validation'=>'required|min:1|max:150','width'=>'col-sm-6'];
